...
export declare function getFakeClassificationDataset(description: SupervisedDictionaryLearningDatasetDescription, difficulty?: 'easy' | 'medium' | 'hard'): TensorflowDataset;
